...
> **خطای مورد نظر شما در لیست نیست؟** در [گیت‌هاب](https://github.com/pusheco/android-studio-sample/issues?utf8=%E2%9C%93&q=is%3Aissue) به دنبال آن بروید و در صورت نیافتن در آنجا مورد جدیدی مطرح کنید.
...
* **استفاده از گریدل در حالت Offline mode** : برای دانلود سرور باید گریدل در حالت `offline mode` نباشد.
...
* با استفاده از کد زیر گریدل را مجبور به استفاده از یک نسخه‌ی خاصی از آن کتابخانه کنید (کد را بالای بلوک `dependencies` قرار دهید.)
...
این مورد بدین معنی ست که تعداد متد‌های ساخته‌شده بیشتر از تعدادی‌ست که ماشین‌مجازی اندروید می‌تواند آدرس‌دهی کند. برای حل این موضوع باید مالتی‌دکس را در پروژه فعال کنید. برای اطلاعات بیشتر می‌توانید به [داکیومنت‌های اندروید](https://developer.android.com/studio/build/multidex) مراجعه کنید.
