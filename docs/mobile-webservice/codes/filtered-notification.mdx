...
const url = `https://api.pushe.co/v2/messaging/notifications/${PLATFORM}/`;
...
url = f'https://api.pushe.co/v2/messaging/notifications/{PLATFORM}/'
...
$ch = curl_init('https://api.pushe.co/v2/messaging/notifications/' . $PLATFORM . '/'); 
...
func main() {
	url := "https://api.pushe.co/v2/messaging/notifications/" + PLATFORM + "/"
