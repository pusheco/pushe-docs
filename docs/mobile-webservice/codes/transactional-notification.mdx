...
```bash {9}
curl -X POST https://api.pushe.co/v2/messaging/rapid/ -H 'authorization: Token YOUR_TOKEN' -H 'content-type: application/json' -d '{"app_id": "YOUR_APP_ID", "filters": {"device_id": ["device_id_1","device_id_3", "device_id_2", "device_id_4"]}, "data": {"title": "عنوان پیام", "content": "محتوای پیام"}}'
