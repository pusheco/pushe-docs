...
تمام توابع قابل استفاده در کتابخانه‌ی پوشه برای **ری‌اکت نیتیو** در این بخش آورده‌ شده است. برای کسب اطلاعات بیشتر مستندات مرتبط به هر قابلیت را مطالعه نمایید.

## بررسی رجیستر شدن دیوایس در کنسول

[راهنمای بررسی رجیستر شدن دستگاه](/docs/react-native/rn-init)
...
[شناسایی کاربر](/docs/react-native/rn-pusheid)
