...
در این حالت با استفاده از [شناسه اپلیکیشن](/docs/web-api/get-app-id)
که در کنسول پوشه قابل دریافت می‌باشد می‌توانید به تمام کاربران اپلیکیشن‌تان اعلان ارسال کنید.

[مشاهده راهنمای دریافت شناسه اپلیکیشن](/docs/web-api/get-app-id)
...
> **نکته:** برای مشاهده تمامی کلید‌های قابل استفاده در ارسال اعلان به [تمامی کلید های اعلان](/docs/web-api/notification-keys-list) مراجعه کنید.
...
برای مشاهده تمامی کلید های قابل استفاده به بخش [تمامی کلید های اعلان](/docs/web-api/notification-keys-list) مراجعه کنید.
